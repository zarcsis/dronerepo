...
<style>
  body { font-family: system-ui, -apple-system, sans-serif; max-width: 960px; margin: 2em auto; padding: 0 1em; color: #222; line-height: 1.45; }
  ...
  pre { background: #f4f4f4; padding: 0.8em 1em; border-radius: 4px; overflow-x: auto; font-size: 0.9em; }
  table { border-collapse: collapse; width: 100%; margin-top: 0.5em; font-size: 0.93em; }
  th, td { text-align: left; padding: 0.45em 0.7em; border-bottom: 1px solid #eee; }
  th { background: #fafafa; font-weight: 600; }
  td.size { text-align: right; font-variant-numeric: tabular-nums; white-space: nowrap; }
  a { color: #0366d6; text-decoration: none; }
  a:hover { text-decoration: underline; }
  .empty { color: #888; font-style: italic; }
  .meta { margin-top: 3em; color: #888; font-size: 0.85em; }
</style>
</head>
<body>
<h1>dronerepo</h1>
